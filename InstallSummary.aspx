<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InstallSummary.aspx.cs" Inherits="apa_pack.InstallSummary" %>
...
;
    ...
    aWarEndDate = new Array(100);
        ...
        RebuildTable();
            ...
            document.getElementById('ContentPlaceHolder1_FileAttach').addEventListener('change', function () {

            var fileName = this.value.split('\\').pop(); // Extract the file name from the full path
            //alert(fileName)
            var maskedFileName = maskString(fileName);
                document.getElementById('ContentPlaceHolder1_ChooseFile').innerText = "" + maskedFileName;
        });
    ...
    function EditInstallation(From) {
        ...
        var URL = "../EditInstallation.aspx?InstallCode=" + document.all.ContentPlaceHolder1_hdnInstallCode.value + "&From=InsallSummary&Uname=" + document.all.ContentPlaceHolder1_hdnUname.value;
    ...
    function RemoveFromList(removeid) {
        ...
        function AttachValidation() {
            ...
            var FileAttach = document.getElementById("ContentPlaceHolder1_FileAttach").value;
        ...
        function attachclose(msg, InsCode) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="row border-bottom" style="padding: 10px 10px;">
                    <div id="main_sub2_div" class="col-md-12 bg-light">
                        ...
                        <div class="col-8 BarObjactsRight">
                            ...
                            <span>
                                <button id="AccountEditBtn" class="btn btn-outline-dark CommonButton_Auto" type="button" onclick="EditInstallation('InstallSummary')">
                            ...
                            <span><%--letter-spacing: 05px;--%>
                                ...
                                <asp:Button ID="btnCopyIns" runat="server" OnClientClick="return Validation();" value="Copy" class="CommonButton btn-sm" Text="Copy" />
                                        ...
                                        <div class="row">
                                            <div id="main" class="container-fluid">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2 col-md-2 form-lable" style="width: 200px;" align="right"><span style="color: blue">*</span> Model No</div>
                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                        <input type="text" id="txtProduct" readonly="true" name="txtModelNo" runat="server" class="formcontrol_Read form-control-sm" />

                                                    </div>
                                                    <div class="col-sm-2 col-md-2 form-lable" align="right"><span style="color: blue">*</span> Product Dec</div>
                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                        <input type="text" id="txtProductDec" readonly="true" runat="server" class="formcontrol_Read form-control-sm" />
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2 col-md-2 form-lable" style="width: 200px;" align="right">Sales Order </div>
                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                        <input type="text" id="txtSalesOrder" readonly="true" name="txtSalesOrder" runat="server" class="formcontrol_Read form-control-sm" />
                                                    </div>
                                                    <div class="col-sm-2 col-md-2 form-lable" align="right">Sales Order Date</div>
                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                        <input type="text" readonly="true" id="txtSODate" runat="server" class="formcontrol_Read form-control-sm" />
                                                    </div>
                                                    <div class="col-sm-2 col-md-2 form-lable" align="right"><span style="color: red">*</span>Field Update</div>
                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                        <input type="text" id="txtFieldUpdate" readonly="true" name="txtPo" runat="server" class="formcontrol_Read form-control-sm" />
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2 col-md-2 form-lable" style="width: 200px;" align="right"><span style="color: red">*</span> Po </div>
                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                        <input type="text" id="txtPo" readonly="true" name="txtPo" runat="server" class="formcontrol_Read form-control-sm" />
                                                    </div>
                                                    <div class="col-sm-2 col-md-2 form-lable" align="right"><span style="color: red">*</span>Po Date</div>
                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                        <input type="text" readonly="true" id="txtPODate1" runat="server" class="formcontrol_Read form-control-sm" />
                                                    </div>
                                                    <div class="col-sm-2 col-md-2 form-lable" align="right"><span style="color: red"></span>Software</div>
                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                        <asp:DropDownList ID="DDSoftware" readonly="true" runat="server" class="formcontrol_Read form-control-sm"></asp:DropDownList>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2 col-md-2 form-lable" style="width: 200px;" align="right"><span style="color: red">*</span> Invoice No </div>
                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                        <input type="text" id="txtInvoiceNo" readonly="true" name="txtAccount" runat="server" class="formcontrol_Read form-control-sm" />
                                                    </div>
                                                    <div class="col-sm-2 col-md-2 form-lable" align="right"><span style="color: red">*</span>Invoice Date</div>
                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                        <input readonly="true" type="text" id="txtInDate" runat="server" class="formcontrol_Read form-control-sm" />
                                                    </div>
                                                    <div class="col-sm-2 col-md-2 form-lable" align="right">Trade-Up SID</div>
                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2 col-md-2 form-lable" style="width: 200px;" align="right"><span style="color: blue">*</span>Principal</div>
                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                        <input type="text" id="txtPrincipal" runat="server" class="formcontrol_Read form-control-sm" readonly="true" />
                                                    </div>
                                                    <div class="col-sm-2 col-md-2 form-lable" align="right">Distent from Service Location</div>
                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                        <input type="number" id="txtDistentService" readonly="true" runat="server" class="formcontrol_Read form-control-sm" />
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2 col-md-2 form-lable" style="width: 200px;" align="right">Remarks </div>
                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                        <textarea id="txtComments" readonly="readonly" rows="3" runat="server" class="formcontrol_Area_Read form-control-sm" maxlength="500" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"></textarea>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="container-fluid">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-2 col-md-2 form-lable" style="width: 200px;" align="right"><span style="color: red">*</span>Install Date</div>
                                                        <div class="col-sm-10 col-md-2 form-text" align="left">
                                                            <input type="text" readonly="readonly" id="txtInstallDate" runat="server" class="formcontrol_Read form-control-sm" />
                                                        </div>
                                                        <div class="col-sm-2 col-md-2 form-lable" align="right"><span style="color: blue">*</span>Warranty Start</div>
                                                        <div class="col-sm-10 col-md-2 form-text" align="left">
                                                            <input type="text" id="txtWSDate" readonly="true" runat="server" class="formcontrol_Read form-control-sm" />
                                                        </div>
                                                        <div class="col-sm-2 col-md-2 form-lable" align="right"><span style="color: blue">*</span>Warranty End</div>
                                                        <div class="col-sm-10 col-md-2 form-text" align="left">
                                                            <input type="text" id="txtWEDate" readonly="true" runat="server" class="formcontrol_Read form-control-sm" />
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-2 col-md-2 form-lable" style="width: 200px;" align="right"><span style="color: red">*</span> Warranty Type</div>
                                                        <div class="col-sm-10 col-md-2 form-text" align="left">
                                                            <input type="text" id="txtWarrantyType" readonly="readonly" runat="server" class="formcontrol_Read form-control-sm" />
                                                        </div>
                                                        <div class="col-sm-2 col-md-2 form-lable" align="right"><span style="color: red">*</span> Month</div>
                                                        <div class="col-sm-10 col-md-2 form-text" align="left">
                                                            <input type="number" id="txtMonth" readonly="readonly" runat="server" class="formcontrol_Read form-control-sm" />
                                                        </div>
                                                        <div class="col-sm-2 col-md-2 form-lable" align="right">Number Of Visit</div>
                                                        <div class="col-sm-10 col-md-2 form-text" align="left">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6 col-md-6 col-lg-6 form-lable" style="padding: 0px 15px;">
                                                                    <button type="submit" runat="server" id="btnSubmit" readonly="readonly" style="width: 130px; height: auto; vertical-align: middle;" class="CommonButton_Auto1 disabled"><i style="letter-spacing: 08px;" class="bi bi-plus"></i>Add To List</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="container-fluid">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-2 col-md-2 form-lable" style="width: 200px;" align="right"><span style="color: red">*</span>Account</div>
                                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                                        <input type="text" id="txtAccount" runat="server" class="formcontrol_Read form-control-sm" readonly="true" />

                                                                    </div>
                                                                    <div class="col-sm-2 col-md-2 form-lable" align="right"><span style="color: blue">*</span>Industry</div>
                                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                                        <input type="text" id="txtIndustry" runat="server" class="formcontrol_Read form-control-sm" readonly="true" />
                                                                    </div>
                                                                    <div class="col-sm-2 col-md-2 form-lable" align="right"><span style="color: blue">*</span>Site</div>
                                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-2 col-md-2 form-lable" style="width: 200px;" align="right"><span style="color: blue">*</span>Address</div>
                                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                                        <input type="text" id="txtAddress" runat="server" class="formcontrol_Read form-control-sm" readonly="true" />
                                                                    </div>

                                                                    <div class="col-sm-2 col-md-2 form-lable" align="right"><span style="color: blue">*</span>City</div>
                                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                                        <input type="text" id="txtCity" name="txtAccount" runat="server" class="formcontrol_Read form-control-sm" readonly="true" />
                                                                    </div>
                                                                    <div class="col-sm-2 col-md-2 form-lable" align="right"><span style="color: blue">*</span> State</div>
                                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                                        <input type="text" id="txtstate" name="txtstate" runat="server" class="formcontrol_Read form-control-sm" readonly="true" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-2 col-md-2 form-lable" style="width: 200px;" align="right"><span style="color: blue">*</span> Pin Code</div>
                                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                                        <input type="text" id="txtPinCode" runat="server" class="formcontrol_Read form-control-sm" readonly="true" />
                                                                    </div>
                                                                    <div class="col-sm-2 col-md-2 form-lable" align="right"><span style="color: red">*</span>Contact</div>
                                                                    <div class="col-sm-10 col-md-2 form-text" align="left">

                                                                        <input type="text" id="DDContact1" runat="server" class="formcontrol_Read form-control-sm" readonly="true" />
                                                                    </div>
                                                                    <div class="col-sm-2 col-md-2 form-lable" align="right"><span style="color: blue">*</span> Mobile</div>
                                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-2 col-md-2 form-lable" style="width: 200px;" align="right"><span style="color: blue">*</span> Department</div>
                                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                        ...
                                                        <div class="row">
                                                            <div class="container-fluid">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-2 col-md-2 form-lable" style="width: 200px;" align="right">Engineer 1</div>
                                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                                        <input type="text" id="TexEngineer1" runat="server" class="formcontrol_Read form-control-sm" readonly="true" />
                                                                    </div>
                                                                    <div class="col-sm-2 col-md-2 form-lable" align="right">Engineer 2</div>
                                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                                        <input type="text" id="TexEngineer2" runat="server" class="formcontrol_Read form-control-sm" readonly="true" />
                                                                    </div>
                                                                    <div class="col-sm-2 col-md-2 form-lable" align="right">Sub Status</div>
                                                                    <div class="col-sm-10 col-md-2 form-text" align="left">
                                                                        <input type="text" id="txtsubstatus" runat="server" class="formcontrol_Read form-control-sm" readonly="true" />
                                                                    </div>
                ...
                <%--section 4--%>
                        ...
                        <div id="AttachmentInfo" style="display: none;">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne2" class="accordion2-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample1">
                                ...
                                <div id="Attachcontainer" class="container-fluid" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2 col-md-2 form-lable"  align="right"><span style="color: red">*</span>Attachment</div>
                                        <div class="col-sm-10 col-md-2 form-text" align="left">
                                            <label class="custom-file-upload">
                                                <asp:FileUpload ID="FileAttach" TabIndex="32" Style="padding: 4px;"  Font-Size="12px" runat="server" />
                                                <img src="images/Icon feather-upload-cloud.png" style="vertical-align: middle; height: 15px; width: 15px;top: 20px;position: relative;" alt="In Progress" border="0" /> 
                                                <span id="ChooseFile" style="font-size: 11px;" runat="server">Choose File</span>

                                            </label>
                                        </div>
                                        <div class="col-sm-2 col-md-2 form-lable"  align="right"><span style="color: blue">*</span> User Name </div>
                                        <div class="col-sm-10 col-md-2 form-text" align="left">
                                            <input type="text" readonly="true"  id="txtUserName" runat="server" class="formcontrol_Read form-control-sm" />
                                        </div>

                                        <div class="col-sm-2 col-md-2 form-lable"  align="right"><span style="color: blue">*</span> Date </div>
                                        <div class="col-sm-10 col-md-2 form-text" align="left">
                                            <input type="text" readonly="true"  id="txtDate" runat="server" class="formcontrol_Read form-control-sm" />
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2 col-md-2 form-lable"  align="right">Comments </div>
                                        <div class="col-sm-10 col-md-2 form-text" align="left">
                                            <textarea id="txtComment" rows="3" runat="server" class="formcontrol_Area form-control-sm" maxlength="500" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"></textarea>
                                        </div>
                                        <div class="col-sm-2 col-md-2 form-lable"  align="right"></div>
                                        <div class="col-sm-10 col-md-2" align="left">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div>
                                            <center>
                                                <asp:Button ID="btnAttach" runat="server" Style="width: 130px" OnClientClick="return AttachValidation();" value="Save" class="SubmitButton btn-sm" Text="Save" OnClick="btnAttach_Click" />
                                            </center>
                                        </div>
                                    </div>
                                    ...
                                    <%--class="panel-collapse collapse"--%>
                                            <div id="ProductInfoContainer"  role="tabpanel" aria-expanded="true" aria-labelledby="AccountInfoHeading"">
                                                <div class="panel-body">
                                                    ...
                                                    <center>
                                                        <div class="ContainerHeader" style="text-align: center; height: 30px; border: 1px solid orange; border-radius: 5px; color: black; width: 175px;align-content: center;">
                                                            <span>Count of Attachment : <asp:Label Style="font-weight: 600;" ID="LabAttachCount" runat="server" ></asp:Label> </span>
                                                        </div>
                                                    </center>
    ...
    <script type="text/javascript">
        ...
        if (document.getElementById('attachimg')) {
            ...
            document.getElementById('ContentPlaceHolder1_NoAttachments').innerHTML = "<table class='bodytxt_black' cellspacing='0' cellpadding='4' rules='all' border='1'  style='width:100%;border-collapse:collapse;'><tbody><tr style='color:Red;text-align:center;'><td colspan='4'>No Records to Display</td></tr></tbody></table>";
        ...
        $(function () {
            ...
            $('#ContentPlaceHolder1_SRAttachments').carouFredSel({
                responsive: true,
                auto: false,
                prev: '.prev3',
                next: '.next3',
        ...
        $("#ContentPlaceHolder1_dotcomments").click(function () {
            $(this).remove();
            $("#ContentPlaceHolder1_SRAttachments li").attr("style", "height:auto!important");
        });
