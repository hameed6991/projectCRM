<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Installation.aspx.cs" Inherits="apa_pack.Installation" %>
...
<script type="text/javascript">
    ...
    function AddInstallationscreen()
    {
            ...
            <div class="row border-bottom" style="padding:10px 30px;">
                <div id="main_sub2_div" class="col-md-12 bg-light">
                    ...
                    <div class="col-md-8 BarObjactsRight">
                        ...
                        <span>
                            <button id="AccAddBun" class="btn btn-warning CommonButton" type="button" onclick="AddInstallationscreen()"><i id="AccAddicon" class="bi bi-plus"></i>New Installation </button>
                        </span>
                        <span>
                                ...
                                <ContentTemplate>
                                    ...
                                    BorderColor="#1e2f97"--%>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-Width="50" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" HeaderText="Print">
                                                <HeaderStyle />
                                                <ItemTemplate>
                                                    <a href="#" onclick='<%# "javascript:CallInsPrint(\"" +  Eval("InstallCode")  +  "\",\"" + "Followup" + "\");return false; " %>'>
