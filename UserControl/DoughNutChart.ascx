<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DoughNutChart.ascx.cs" Inherits="apa_pack.UserControl.DoughNutChart" %>
...
<script src="https://cdn3.devexpress.com/jslib/23.1.6/js/dx.all.js"></script>
    ...
    <form runat="server" >
        ...
        <div class="row mx-n2" style="padding: 10px 20px 10px 20px;">
            ...
            <div class="col-12 gadget_top_bg">
                <div class="row align-items-center">
                    ...
                    <div class="col-10 col-sm-8 text-left px-0">
                        <span class="Title">Pending Service Request new</span>
            ...
            <!-- Chart Section -->
            <div class="col-12 trchart1 collapse show text-center mt-12">
                <div id="DoughNutDesign" style="cursor: pointer;padding: 50px 0px;">
                    <!-- Chart Content Here -->
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function waitForDxChart1(callback, retries = 10, delay = 500) {
    ...
    function procDrawDoughNutDesign() {



        var obj = [
            { InnerCircle: "Category A", INos: 35 },
            { InnerCircle: "Category B", INos: 45 },
            { InnerCircle: "Category C", INos: 20 },
            { OuterCircle: "Category D", ONos: 60 },
            { OuterCircle: "Category E", ONos: 30 }
        ];

        $("#DoughNutDesign").dxPieChart({
            dataSource: obj,
            type: "doughnut",
            series: [
                //{
                //    argumentField: "InnerCircle",
                //    valueField: "INos",
                //},
                {
                    argumentField: "OuterCircle",
                    valueField: "ONos",
                }
            ],
            size: { height: 230 },
            ...
            palette: ['#FFB900', '#006FB6', '#994FEC', '#DD5551', '#005396'],
        });
