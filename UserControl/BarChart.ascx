<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BarChart.ascx.cs" Inherits="apa_pack.User_Control.BarChart" %>
 ...
 <form runat="server" >
        ...
        <div class="row mx-n2" style="padding: 10px 20px 10px 20px;">
            ...
            <div class="col-12 trchart1 collapse show text-center mt-3">
                <div id="BarchartDesign" style="cursor: pointer;">
                    <!-- Chart Content Here -->
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function procDrawBarChart() {
        ...
        var chartContainer = $("#BarchartDesign");
        //alert(obj)
