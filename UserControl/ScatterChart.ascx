<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ScatterChart.ascx.cs" Inherits="apa_pack.UserControl.ScatterChart" %>
 ...
 <form runat="server" >
        ...
        <div class="row mx-n2" style="padding: 10px 20px 10px 20px;">
            ...
            <div class="col-12 gadget_top_bg">
                <div class="row align-items-center">
                    ...
                    <div class="col-10 col-sm-8 text-left px-0">
                        <span class="Title">Pending Service Request</span>
            ...
            <div class="col-12 trchart1 collapse show text-center mt-3">
                <div id="ScatterChartDesign" style="cursor: pointer;">
                    <!-- Chart Content Here -->
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function waitForDxChart5(callback, retries = 10, delay = 500) {
    ...
    function procDrawScatterChart() {
        var obj = [
            ...
            { Date: "07-22", Sales: 0 },
            { Date: "07-23", Sales: 0 },
            { Date: "07-24", Sales: 650000 },
            { Date: "07-25", Sales: 0 },
            { Date: "07-26", Sales: 0 },
            { Date: "07-27", Sales: 0 },
            { Date: "07-28", Sales: 0 },
            { Date: "07-29", Sales: 1100000 }
        ];

        $("#ScatterChartDesign").dxChart({
            dataSource: obj,
            ...
            tooltip: {
                ...
                customizeTooltip: function (arg) {
                    return {
                        text: "Sales: ₹" + arg.value.toLocaleString()
                    };
                }
            },
            argumentAxis: {
    ...
    //        { Name: "Region D", Complaint: 6, Demo: 17, "Additional PM": 1 }
    //    ];
    //    //alert(obj)
    //    var isFirstLevel = true;
    //    var chartContainer = $("#ScatterChartDesign");
    //    //alert(obj)
