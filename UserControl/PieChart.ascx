<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PieChart.ascx.cs" Inherits="apa_pack.UserControl.PieChart" %>
 ...
 <form runat="server" >
        ...
        <div class="row mx-n2" style="padding: 10px 20px 10px 20px;">
            ...
            <div class="col-12 gadget_top_bg">
                <div class="row align-items-center">
                    ...
                    <div class="col-10 col-sm-8 text-left px-0">
                        <span class="Title">Pie Chart Design</span>
            ...
            <div class="col-12 trchart1 collapse show text-center mt-3">
                <div id="PiechartDesign" style="cursor: pointer;">
                    <!-- Chart Content Here -->
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function waitForDxChart3(callback, retries = 10, delay = 500) {
    ...
    function procDrawPieChart() {
        ...
        var chartContainer = $("#PiechartDesign");
        //alert(obj)
